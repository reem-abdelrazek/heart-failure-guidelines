...
class ChatbotService:
    def __init__(self):
        self.client = Groq(api_key="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")
    ...
    def answer_question(self, db_table_result, db_text_result, question):
        ...
        chat_completion = self.client.chat.completions.create(messages=messages, model=CHATBOT_MODEL_NAME)
